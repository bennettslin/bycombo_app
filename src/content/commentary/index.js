...
Here, then, is another reason why "elite capture" is poorly named, as stated in my previous commentary: It keeps us from noticing the same pattern play out in *anti*-elitist cultures like indie rock! So let's call *all* of it "cred"… Because, what's so different between the underground and any formal institution, if both can be "captured" by strivers sending all the right signals?
    `],
    [`populism`, `
${'  ' || `
