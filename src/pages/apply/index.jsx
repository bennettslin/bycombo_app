...
const Component = () => (
    <Page
        {...{
            ...
            body: `
${'  ' || `
// TODO: Revise. Still needs work, I think.
`}

As an artist, do you sense that the indie camp has it all *backward*? Why do they force you to waste so much effort to build a fanbase on your own— all in the name of empowering yourself? Back when rock was interdependent, self-empowerment just came for free, once you'd built up enough talents.
