...
There's nothing wrong with indie rock's artistic libertarianism, per se— but it's a *partisan* ideal that gets mistaken as *universal*. So when a band struggles to be indie because it's a poor fit for their circumstances, they're told to just suck it up and try harder. Now with BYCombo, there's finally an opposition party you can join.
...
Don't be fooled, either, by indie rock's belated embrace of minority artists. They've been handed the reins *because* it's in decline; these are crumbs on offer here. No, the best movements for minorities are the ones they founded *themselves*, that reflect *their* circumstances— and thus reward what can't be bought: originality and talent, born from an outsider's hunger.

Hip hop is the latest case in point, and BYCombo— which I founded to serve *all* disadvantaged groups— will prove to be the next. As a minority myself, I know firsthand that disadvantage drives your instinct for *mutual* reliance, as well as your hunger to aim for the *top* of the pantheon.
