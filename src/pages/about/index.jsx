...
Critical acclaim can be inflated, which makes it a terrible barometer. What *can't* be hacked is the historical canon, because making history means competing on equal terms with past artists who *didn't* rely on charitable support. In this light, it's likely that *no* indie artist today will be inducted— and *this* is why people gripe that rock is getting worse.
...
It's because paid dues are worthless outside the one system that honors them. As a result, those who pay their dues will forever be loyal to the system, and they'll see no need for reform.

But not only that, having squandered their potential to build up symbolic credentials rather than actual talents, they'll never feel secure enough to let others surpass them. So the only newcomers they can accept are the ones willing to squander even *more* potential. But these newcomers will then feel even *less* secure— thus perpetuating a vicious circle.
...
The reason is that we mostly pine for past artists who sacrificed themselves for art's sake. But indie rock is here to *save* artists from exploitation, and so it roots for those who *empower* themselves instead. As such, today's indie artists demand to be fairly compensated; they don't self-sacrifice for *anyone*, because to do so is a classic sign of being exploited.

But the problems with this current Age of Empowerment go beyond its failure to deliver the next Nirvana. For one, self-empowerment is really just self-serving, power-seeking behavior in those we see as underdogs; it's not noble in and of itself. For another, in a decentralized system, artists with this trait hold the *advantage*— so how exactly are *they* the underdogs?

But worst of all, self-empowered artists will never *start* a revolution, because the means to fair compensation get settled only at the very *end*. If rock is to be saved, then, we *need* to make way for selfless bands who'll self-sacrifice for art's sake. In other words, after Empowerment… comes the Age of Martyrdom.
