...
${'  ' || `
// TODO: Again review last sentence.
`}
...
After working as a coder to build up my skills for the audio webcomic, I came back to the music world and was shocked to hear so many indie artists speak of "paying their dues"— to justify, let's say, touring at a loss. In the tech world, "paid dues" is a synonym for fake work; industries that revolve around it get disrupted— by outsiders. But why doesn't reform ever come from within?

One reason is that dues are paid by following familiar conventions; nothing innovative counts. So when a convention degrades over time— like building a fanbase by touring, which makes less sense as society moves online— there's no one around to fix this with an ingenious solution. Any innovators have long self-selected themselves out.
