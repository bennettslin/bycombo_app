...
Indie rock encourages self-reliance by empowering artists to bypass the middleman. But if the middleman's job is simple enough for artists to do themselves, then any wealthy artist can just pay *others* to do it— including, ironically, former middlemen! So indie rock has devolved into a playground for the privileged, leading to today's disillusionment. How did this happen?

The root cause is that indie rock enjoys the goodwill generated by artistic movements of *cooperative* self-reliance, like the Maker Faire, that are united by love of the *craft*. But indie rock is really about *competitive* self-reliance, like libertarianism in politics; it's grounded in excitement for the *hustle*. And nothing makes the hustle easier— and thus more exciting— than privilege.

There's nothing wrong with indie rock's artistic libertarianism, per se— but it's a *partisan* ideal that gets mistaken as *universal*. So when a band struggles to be indie because it's a poor fit for their circumstances, they're told to suck it up and try harder. Now with BYCombo, there's an opposition party that advocates for the interdependence you want, out of respect for your craft.

### *For* hungry outsiders, *by* a hungry outsider

Who foresaw indie rock's ironic endgame? Minorities did— which is why they've never founded a movement that rewards self-reliance. By the way, don't be misled by hip hop's bravado: When rappers boast of past hustles, what they're really saying is, "Hey, *I* hustled *too*." It's to *prevent* self-reliance from allowing *rivals* to earn respect.

Don't be fooled, either, by indie rock's belated embrace of minority artists. They've been handed the reins *because* it's in decline; these are crumbs on offer here. No, the best movements for minorities are the ones *they* started *themselves*, that reflect *their* circumstances— and thus reward what can't be bought: originality and talent, born from an outsider's hunger.
...
After working as a coder to build up skills needed for my audio webcomic, I came back to the music world and was shocked to hear indie artists speak of "paying their dues"— to justify, let's say, touring at a loss. In the tech world, "paid dues" is understood to mean fake work; industries that revolve around it get disrupted— by outsiders. Why don't those on the inside see this first?

One reason is that for paid dues to be measured fairly, everyone must follow familiar conventions; invention doesn't count. So as a convention degrades over time— like touring to build a fanbase, which makes less sense as society moves online— no one around sees this as a solvable problem, because those who love to find inventive solutions have already opted out.

But the main reason is that paid dues aren't backed by anything of genuine value. They're awarded to those who can tolerate doing fake work the longest. So those who've paid their dues, and those whose power comes from recognizing paid dues, will work to ensure that reform never happens, because reform, by its very nature, must necessarily invalidate pointless credentials.

// TODO: They can't ever create a smarter and more efficient discovery process.

This is why it took an outsider to found BYCombo, that's based on the obvious solution of incentivizing artists to do the things that matter. It's not that your favorite indie artists and labels don't see a way to stop rock from getting worse. Rather, it's that they don't want to stop it.
