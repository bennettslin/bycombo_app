...
Indie rock encourages self-reliance by empowering artists to bypass the middleman. But if the middleman's job is simple enough for artists to do themselves, then any wealthy artist can just pay someone *else* to do it— including, ironically, a former middleman! So indie rock is now a playground for the privileged, leading to today's disillusionment. How did this happen?
...
The reason is that we only pine for past artists who sacrificed themselves for art's sake. But indie rock is here to *save* artists from exploitation, and so it roots for those who *empower* themselves instead. As such, today's indie artists demand to be fairly compensated; they don't self-sacrifice for *anyone*, because to do so is a classic sign of being exploited.
