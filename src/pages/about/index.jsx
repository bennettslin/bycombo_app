...
But a bigger reason is that paid dues have no worth *outside* the system, so those who've paid their dues can never feel secure enough to let others surpass them. As such, every newcomer gets told to take on even *more* fake work. But doing so leaves these newcomers with even *fewer* talents, causing them to feel even *less* secure— and so on, in a vicious circle.
