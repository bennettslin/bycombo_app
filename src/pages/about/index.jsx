...
${'  ' || `
// TODO: Needs work again. Second paragraph, mention it can never be what women and minorities want.
`}
...
And since indie rock is *defined* by its ideology, it must *always* reflect the values of its White male founders. So don't be fooled by the recent fuss over its increasing diversity; there was no outreach. Society is simply at a point now where *some* female and minority artists are privileged enough to compete on self-reliance just fine.

But why is indie rock so eager now to hand over the reins to us women and minorities? For the same reason a [Fortune 500 company](https://en.wikipedia.org/wiki/Glass_cliff) would be: It's in *decline*. No thanks! The best movements *for* us are the ones founded *by* us, to fit *our* circumstances— which thus reward what can't be bought: originality and talent, born from an outsider's hunger.

Hip hop was the last case in point, and BYCombo will be the next. And what benefits us, benefits *all* disadvantaged groups: We know that disadvantage drives your need for *mutual* reliance, as well as your hunger to aim for the historical canon.
