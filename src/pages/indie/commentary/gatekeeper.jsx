...
It helps to think of a literal gate— the purpose of which is to let in those who'd otherwise be shut out, while barring others who'd march right in. Without it, we'd revert to the natural order of "might makes right"… and in the arts, such might comes from concrete metrics. So the indie camp, which judges you on the size of your fanbase, stands *against* gatekeeping.

${'  ' || `
// TODO: Keep working on. Finish up this point. Shut out. Unproven.
`}
