...
But if your dream, like mine, is to be picked based on immeasurable qualities like talents and originality— in other words, what the major labels looked for in their heyday— then you're *with* the gatekeepers. In which case, I could use some help with putting them back in charge!
            `,
        }}
    />
)
