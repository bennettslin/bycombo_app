...
const Component = () => (
    <Page
        {...{
            ...
            body: [
                `
As we all know, those in the indie camp largely sit on the political *left*. With this being the case, some of you might push back on my claim that, given an artistic spectrum to mirror the political one, they'd sit on its *right*. If so, then just sit tight: My reasoning will be made clear as you read on! Still, I can give a hint of it here and now.
