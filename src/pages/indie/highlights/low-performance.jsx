...
> Drift to low performance feeds upon itself: As everyone gets used to mediocrity, it's easy for standards to slip still further— which [then] lowers expectations and allows even worse performance. […] Once a slide downhill gets going, it's hard to stop, because no one believes that what was once possible is possible any more.
