...
As their party devolved into "indieocracy," many Republicans thought they'd resist; instead, most learned to embrace the hustlers who'd now taken over— perhaps to their own surprise. Similarly, every indie gatekeeper I've met with, despite being impressed by [my projects](https://digital.lib.washington.edu/researchworks/handle/1773/23566), ended up dismissing me as a hobbyist— yet some seemed genuinely surprised by their own decision.

Once you're loyal to a culture, then, you *will* help its chosen winners defeat the losers— even if that choice surprises you. But indieocracy is so bleak, I still had to wonder: Shouldn't I have met an indie gatekeeper by now who'd rather just *leave*— as I have? Then one day it clicked: I *haven't* met a hundred of them. I've only met with the same one— a hundred times over!
