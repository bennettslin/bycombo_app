...
In his book [*The Nineties*](https://www.penguinrandomhouse.com/books/557048/the-nineties-by-chuck-klosterman), Chuck Klosterman notes that Gen X's only bugbear was *commercialism*. That is to say: "You can sell; just [don't sell *out*](http://archive.today/2022.10.12/https://www.rollingstone.com/feature/nirvana-inside-the-heart-and-mind-of-kurt-cobain-103770/#:~:text=%E2%80%9CI%20don%E2%80%99t%20blame,identity%20so%20righteously.%E2%80%9D)." The indie camp then took it further: "Do the selling yourself— or else you're being *sold*." Finally, Millennials adopted this ideal as their own… until the hustle burned them out. Now they rail against the need to sell at all— or, *capitalism* itself.

Which… has led to the worst of both worlds! Millennials *readily* sell out, even as they retain the core belief that underlies a *refusal* to do so: "Who you *are* is more important than what [you get *done*](https://bennettsamuellin.blogspot.com/2013/06/unjamming-next-generation.html)." In other words, their generation's concern is an individualist one for *identity*, rather than a collectivist one for *impact*. No wonder, then, that they just haven't done much…

To make matters worse, indie rock is the first rock movement whose ideals are based on *ethics*, not *aesthetics*. This means there's no precedent to show us how to counter these ideals— or even to say that we *should*. And because guarding one's identity includes maintaining one's ethics, Millennials have long insisted that we *shouldn't*.
