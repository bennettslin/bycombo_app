...
Hair metal combined glam's gender-bending look with metal's aggression. It was a perfect youth movement— for the previous generation. As for Gen X… they saw it as a tired rehash. But indie rock's rule for artists to hustle was no less a relic by the '00s— yet Millennials embraced it as their own! So rather than break any rules, they just [role-played](https://en.wikipedia.org/wiki/Live_action_role-playing_game), or "larped," the *idea* of doing so.
...
Here's my guess: Courage is inspired by scarcity— but Millennials only knew information scarcity long enough to fear it. They were then given structured ways to defeat it, which won their loyalty for good— just like Boomers stayed loyal to the [fast food](https://media.newyorker.com/photos/5c3e10b2f92c694343cc71b9/master) that defeated *food* scarcity. As such, Millennials fail to see that the *only* rules left… are the structural ones that *they* enforce!

There's more: When information was scarce, joining a scene— punk, rave— took commitment; it meant rejecting all the rest. This taught Gen X to stand fiercely for their side— knowing that [tribalism is dumb](https://web.archive.org/web/20120321043412/http://www.mitchclem.com/nothingnice/196). But since Millennials were free to be eclectic, they now see it the other way around: Taking a stand is *just* a larp— while anyone who breaks their rules is an *actual* threat.

Yet there's good news: Now that Gen Z has only ever faced an *abundance* of information, they [long for a return](https://writingball.blogspot.com/2022/12/logan-lane-and-luddite-club.html) to its *scarcity*— along with the courage this inspires. And just in time… to
 try an Xennial's solution! With BYCombo, you can aim for the canon once more, in perhaps the only way left that *isn't* a larp: by doubling down to make art, for a serious chunk of lifetime.
