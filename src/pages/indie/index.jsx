...
Sadly, today's young people never question this auto-Bizarro world, since it's all they've ever known. Luckily, I came of age *before* indie rock took over, so I've *only* ever dreamt of having one job as an artist— as there's no other way to be the best at it! Now with BYCombo, this dream can be yours as well.

### ${++sectionCounter}. Competitive self-reliance favors privilege

${'  ' || `
// TODO: Review a few more times. Does the first paragraph make sense?
`}

In doing the middleman's job for themselves, indie artists become emblems of self-reliance. Yet a [wealthy artist](https://knowyourmeme.com/photos/2316349-parent-names-are-blue-on-wikipedia) can secretly pay *others* to do this work… and, well, who better to hire than a freelance middleman?! So in the end, indie rock has done little more than "privatize" access to business deals that were once "public"— to the benefit of the privileged. How did this happen?
