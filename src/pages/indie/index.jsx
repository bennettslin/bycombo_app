...
In the '90s, "indie" meant bands like Pavement, who'd only ever signed to an indie label. As Gen X knows, then, Nirvana and Radiohead were alternative, not indie; they were on *major* labels. To Millennials, though, a band is indie if they *sound* indie— which means we're now waiting for the *indies* to give us the next Nirvana or Radiohead! How did we get so confused?
...
We all respect those alternative bands of the ['80s underground](https://www.hachettebookgroup.com/titles/michael-azerrad/our-band-could-be-your-life/9780316247184), right? "Of course! They were chosen by the people, *not* by the elites." Well, actually… this is yet more Millennial confusion. Back then, the underground *lacked* popular appeal; it was a shelter both for rock's underclass— who *subverted* the people's will— and for the elitist snobs who championed their works.

${'  ' || `
// TODO: Review, and review link.
`}    

In the '90s, though, we [began calling](https://books.google.com/ngrams/graph?content=%22+alternative+rock+%22%2C%22+indie+rock+%22%2C%22+underground+rock+%22&year_start=1980&year_end=2000) underground bands "indie," to affirm that they *didn't* leave for a major label. Yet, unlike being underground, being indie *can* be a universal ideal— so once the Internet made this possible, the indie camp declared that it *should* be. Now *any* artist who hustles to build a fanbase is considered indie… even one with mainstream tastes!
