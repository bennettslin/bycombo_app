...
${'  ' || `
// TODO: Use another word than advocate.
`}
...
Make sure first paragraph's logic flows correctly.

Still need to work on fourth paragraph.
`}

A historian's job is to shine a light on all that deserves to be known about the past— so if you make art that *deserves* to be known, it *will* be. Which means those who care to be on the right side of history will help to make it happen sooner. This is why I decided to create the "*Ulysses* of rock albums"— because why waste effort on *being* known, when you can simply *deserve* to be?

Yet each time I showed [*Yearling's Bobtail*](https://www.yearlingsbobtail.com) to an indie label, they'd agree it was impressive, only to then pass on signing us— which puzzled me. Were *they* mistaken about what makes it into history— or was *I*? But in time I learned the reason: Indie rock *doesn't* care to be on the right side of history at all!

Because indie artists are required to make themselves known, the valuable commodity isn't their music itself, but the public's *knowledge* of it. So if *any* artist were allowed to be known for free, then *every* artist would expect it— and the entire system would collapse. Which means indie rock can *never* agree that some works of art simply *deserve* to be known!

But BYCombo cares. Because if bands deserve to be known for sacrificing a serious chunk of lifetime to advance the art form… future historians now have a way to find them.
