...
Don't need to mention self-reliance at all in first paragraph.

In second paragraph, say indie rock is lumped together with these movements of cooperative self-reliance. And thus it enjoys the same goodwill, and assumption that there's no opposition.
`}

In doing the middleman's job themselves, indie artists are seen as emblems of self-reliance. Yet a [wealthy artist](https://knowyourmeme.com/photos/2316349-parent-names-are-blue-on-wikipedia) can quietly pay *others* to do this work… and, well, who better to hire than a freelance middleman?! So in the end, indie rock has done little more than "privatize" access to business deals that were once "public"— to the benefit of the privileged. How did this happen?
