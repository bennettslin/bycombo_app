...
But this misses the point, doesn't it? Once "verification" is trivial to attain, it ceases to be an [honest signal](https://en.wikipedia.org/wiki/Signaling_game); we can no longer assume that those who have it are worth hearing from. In fact, the loudest signals will now be sent by the *least* worthy, who can just invest in the signal itself— rather than in the worth being verified! Should it surprise us, then, if the [audience leaves](https://youtu.be/Ag4iFa6E_yY)?
...
Instead, they long to receive— and thus send!— honest signals once more. But can they? Yes! By leaving… for BYCombo. Because what better way to verify your worth is there, than sacrificing a serious chunk of lifetime for it?
