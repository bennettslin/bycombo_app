...
This is silly, of course: The *audience* would object! They only want the *best*— and they *won't* tire themselves to find it. If "indie sports" took over, then, they'd turn to television or video games, and only come back for "classic sports" reruns. We all get this, right? Okay. Well… indie rock *did* take over. So how come no one can figure out why the audience for music [is leaving](https://youtu.be/Ag4iFa6E_yY)?!

But there's hope: While Millennials were active creators from day one, Gen Z reverted to being passive consumers once the Internet consolidated. As with Gen X, then, Gen Z relates foremost to the *audience*— having first been one themselves. So today's pro-*artist* slant might just be a generational fluke… and *not* the future of music.
