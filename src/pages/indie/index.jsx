...
The problem is that indie rock enjoys the goodwill generated by artistic movements of *cooperative* self-reliance, like the Maker Faire, that are united by love of the *craft*. Now, this would be fitting— if indie artists were simply encouraged to make music for *themselves*.

But indie rock empowers them to command the attention of *others*— and there's only so much of that to go around. This means it's really about *competitive* self-reliance; like [libertarianism](https://en.wikipedia.org/wiki/Libertarianism) in politics, it's grounded in excitement for the *hustle*. And nothing makes the hustle easier— and thus more exciting— than privilege.
