...
${'  ' || `
// TODO: Keep working on. Make it clear that indie rock opposes the historians because it needs to keep the full truth hidden.

Third paragraph: Find way to phrase works of art deserve to be known by themselves.

Maybe put the part about deserving to be known in the second paragraph, and hiding the full truth in the third paragraph.

Still need to work on fourth paragraph.
`}

Whatever deserves to be known of our times, future historians will reveal in due course— which means those who care to be on the right side of history will help to make it known *now*! So this was my thinking when I decided to create the "*Ulysses* of rock albums"— because why waste any effort on *being* known, when you can simply *deserve* to be?

Yet each chance I got to show [*Yearling's Bobtail*](https://www.yearlingsbobtail.com) to an indie label, they'd agree it was impressive, and then pass on signing us— which left me puzzled. Were *they* mistaken about what history wants… or was *I*? But in time I understood the reason: Indie rock *isn't* here to be on the right side of history!

Because indie artists are required to make themselves known, the precious commodity isn't their music itself, but the public's *knowledge* of it— and *this* is what determines its worth. If *any* artist were allowed to be known for free, then *every* artist would expect the same— causing the system to collapse. For indie rock to exist, the truth of our times *must* remain hidden.

Yet no one today respects the efforts of past movements to hide the truth of their times— and no one tomorrow will respect indie rock's efforts today. For as long as self-sacrificing bands advance the art form deserve to be known… future historians will have a way to find them.
