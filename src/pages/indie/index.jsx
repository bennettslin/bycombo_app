...
So either it's an advantage to hustle, or it *isn't* a disadvantage *not* to. You can't want both; they lead to opposite outcomes. Pro-artist unity is an illusion! But when I pointed this out in the '00s… I turned out to be a lone holdout. And for blocking the indie camp's aim to unite music's 99%, I was shut out— like the brutalized child in Ursula Le Guin's [story of Omelas](https://en.wikipedia.org/wiki/The_Ones_Who_Walk_Away_from_Omelas).
