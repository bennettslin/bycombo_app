...
But given that *most* people belong to the mainstream, artists who cater to such tastes end up gaining the most fans— and thus, they're the ones who get picked by the indie gatekeepers! Unsurprisingly, then, indie rock lost its subversive edge in the '00s and became just another hustle culture. And yet, Millennials still defended it, having never known it to be otherwise…
...
Indie artists work hard *not* to need a label, and will do so even [when signed](http://archive.today/20240511/https://pitchfork.com/news/34979-amanda-palmer-tells-roadrunner-records-please-drop-me/#selection-813.0-813.481) to one— on the label's dime! So labels have learned to doubt artists as well… destroying the mutual reliance needed to create cultural wealth. Yet there's hope: Much like South Korea shows what North Korea can one day become, the past proves that rock can be interdependent once again!
...
Still, I had to wonder: Shouldn't *one* by now have given me a chance? Then it clicked: I *haven't* met a hundred indie gatekeepers. I've only ever met with the same one— a hundred times over! After all, being independent means having no weaknesses, and thus no real strengths. As a result, everyone in the indie camp converges on the same well-rounded way of thinking…
...
${'  ' || `
// TODO: Revise. It's still missing something…
`}

In other words, don't be misled by indie rock's belated embrace of women and minorities: It doesn't add up to further diversity of *thought*— or variety in *works*! Let's face it, making "windfall art" *requires* you to be exceptionally strong in matters of art… and thus hopelessly weak in matters of business. BYCombo gets this, and we'll help you find partners who do as well.
