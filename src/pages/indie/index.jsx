...
${'  ' || `
// TODO: Mention that getting heard is a de facto competition.

Any artist who respects the listener will acknowledge that getting heard is a de facto competition. Those who say otherwise are being disingenuous. They still want to compete, just on more favorable and less obvious terms— such as owning a trust fund.
`}
...
${'  ' || `
// TODO: Mention that disadvantaged groups have a realistic understanding of competition.

This is why every movement started by minorities is highly competitive: Disadvantage forces you to engage with the actual reality, not some cozy fantasy in your head.
`}
...
// TODO: Work on this. This is a good section to have.

First paragraph:
Thought experiment: Great light switch. Who wants it? The general public. And also future historians.

Second paragraph:
Be the one who'll shoot to the top once the light switch is flipped. My strategy for Yearling's Bobtail. Yet indie gatekeepers don't behave as I expect. Why?

Third paragraph:
Entire point of indie rock is to spend time and energy to be known. This is the thing that's precious. It *isn't* simply given away for free. But this puts indie rock on the opposite side of the general public and future historians. Wrong side of history!
