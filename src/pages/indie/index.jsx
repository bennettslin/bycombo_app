...
Moreover, once someone has wasted their best years building up symbolic "[cred](/indie/commentary/cred#)" rather than enviable talents, they can never feel secure enough to let others surpass them. So *of course* the only newcomers they'll help are those willing to squander even *more* potential. But these newcomers will then feel even *less* secure— thus widening the [vicious circle](/indie/highlights/vicious-circle#) of brokenness.
...
Which explains why both politics *and* the arts are getting worse in our times: In each case, Millennials keep mistaking [populism](/indie/commentary/populism#) for progressivism— when they're *not* the same! A populist *chastises* the disadvantaged for joining the establishment, whereas a progressive *sympathizes*… and thus joins as well, forgoing the urge to simply "larp" as a revolutionary.
