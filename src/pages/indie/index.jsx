...
The problem is that indie rock enjoys the goodwill generated by artistic movements of *cooperative* self-reliance, like the Maker Faire, that are united by love of the *craft*. Now, if "indie" simply referred to those who *make* their own art, this association would make sense.

But indie rock empowers its artists to *sell* their music directly to the public— which makes it a movement of *competitive* self-reliance. Like [libertarianism](https://en.wikipedia.org/wiki/Libertarianism) in politics, it's grounded in excitement for the *hustle*. And nothing makes the hustle easier— and thus more exciting— than privilege.
...
${'  ' || `
// TODO: Mention why disadvantaged groups have a realist:c understanding of competition? Review BY principle about competition.
