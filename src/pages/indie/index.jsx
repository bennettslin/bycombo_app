...
To make history, a band must develop exceptional strengths. But this isn't humanly possible unless they're allowed to stay weak in business matters like marketing and distribution, where a *partner* can be more efficient. That is to say, they need to be *inter*-dependent— not *indie*-pendent.
...
It takes time to review an ambitious demo— but the indie labels won't put in this effort, since *any* artist they sign will be charitably supported just the same. So an interdependent band's best bet is to work with partners from within a counterculture that *criticizes* indie rock's good intentions— and a public registry is where they'll find each other.
...
Instead, being indie is about commanding the *public's* attention— and this is a [zero-sum game](https://en.wikipedia.org/wiki/Zero-sum_game): While attention is being paid to one artist, it *isn't* paid to the rest. Which means indie rock is really about *competitive* self-reliance! Its artists live for the *hustle*— like [libertarians](https://en.wikipedia.org/wiki/Libertarianism) in politics— and nothing makes hustling easier than privilege.
