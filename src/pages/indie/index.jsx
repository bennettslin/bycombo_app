...
In every early example of online success, chance or privilege clearly played a role. Yet indie rock was so eager to "own" the major labels, it downplayed this point. Well, it worked— the Internet came to be seen as the great equalizer. Except now, as more and more indie artists struggle to succeed online… the public can only assume their music is no good!
...
Revolutions may *start* with artists, but they're *spread* by business partners, whose know-how is needed to win over the public. This is why BYCombo encourages you to explore and experiment while you have no fans to lose— and then helps you find partners secure enough to see how this makes you the *smartest* bet.
...
But indie artists try to command the *public's* attention— and at any given time, attention paid to one *isn't* paid to the rest. Which means indie rock is really about *competitive* self-reliance. Like [libertarians](https://en.wikipedia.org/wiki/Libertarianism) in politics, its artists live for the *hustle*— and nothing makes hustling easier than privilege.
