...
But the situation isn't hopeless: Most fans prefer rock music that *isn't* indie, made by artists who *aren't* charitably supported; industry insiders in genres that *never* went indie, like hip hop, would be happy to lend their expertise to the struggling rock market; and budding entrepreneurs recognize that indie rock is just waiting to be disrupted by a new business model.

${'  ' || `
// TODO: Just review.
`}

So plenty of them would love to hear an interdependent band's ambitious demo— but *not* if this means having to wade through so many lackluster releases, all pouring in through indie rock's low barriers to entry. What's needed to revive interdependence, then, is an alternative movement that willfully *raises* its barriers. Well, here's great news:

**Interdependent bands can now earn the public's trust by adding their demos to BYCombo's registry, which has a steep *cost* of entry: They must sacrifice a serious chunk of lifetime to advance the art form.**
