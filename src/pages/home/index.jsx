...
const Component = () => (
    <Page
        {...{
            ...
            body: `
**As a nonprofit, BYCombo promotes amnesty for interdependent-minded artists who advance the art form. Our approach is to assemble them into rock bands ourselves, and then expose them to potential partners.**
...
**Yes— since rules are made to be followed, bands who refuse to hustle can't complain about remaining unknown. But— breaking the rules is *also* how history gets made! So let's be open to granting them amnesty.**
