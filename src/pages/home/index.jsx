...
By *not* using indie rock's tools, however, I'm seen as a hobbyist— and then my band isn't charitably supported as an indie artist would be. But charitable support is such a [winning advantage](/indie#charitable-support-is-a-supreme-advantage), no other artist can hope to compete. Which means the *labels* can only compete by signing indie artists— who work hard *not* to need them. What a mess! And yet the future is clear:
...
So even as the outsider builds up objective strengths to win over a skeptical public— indie rock assures victory for the underdog by keeping its criteria *subjective*! Which explains why it favors music that *lacks* [well-crafted hooks](/indie#timeless-works-have-intrinsic-appeal), and why it refuses to confront its human bias *against* [creative invention](/indie#creativity-gets-its-chance-from-the-clueless).
...
But if we can't dissent, then let's revolt! How? We simply… wait. See, indie rock has *another* glaring weakness: When a movement *requires* its artists to divert time and energy away from making art— it has no excuse to fall back on if the art ends up being *worse*! So there's already a *way* to revolt against indie rock; we're just waiting for the next generation to have the *will*.
