...
const Component = () => (
    <Page
        {...{
            ...
            body: `
**As a nonprofit, BYCombo offers amnesty to interdependent-minded artists who pledge to advance the art form. Our approach is to assemble them into rock bands ourselves, and then expose them to potential partners.**
...
If we can't resist, though— let's revolt! How? We… wait. See, indie rock has *another* glaring weakness: In judging artists by the size of their fanbase, its tastemakers end up favoring *content*— namely, art that's optimized to gain fans in the *present*, along with all its surrounding context. But content has no *future* chances… and to prove this, we just need time to pass.
