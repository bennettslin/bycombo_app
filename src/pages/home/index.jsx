...
// TODO: ${'  '}
**BYCombo is a nonprofit incubator of rock bands. Our mission is to launch the interdependence revolution, and to make it the most historically consequential rock movement of the 21st century!**

### Tools… are *rules*

Indie rock seeks to lower the barriers to entry by providing artists with tools of empowerment. These tools aren't actually free: They cost the artist's time and energy. And yet they offer no advantage in the end, since *every* artist is expected to use them. They just penalize the ones who *don't*. But… this is how *rules* work! In other words:

**Every tool of empowerment becomes just another *rule* to follow.**

### Calling for a truce

Hi, I'm Bennett. I think indie rock's rules hurt the art form, and I refuse to follow them. Yet if everyone felt this way, then breaking the rules… would be the new rule! So I understand why this attitude sets me back, and why I get no sympathy for it. But at the same time, everyone *else* understands that rule breakers are the ones who make rock history! So how about a truce:

**Since rules are made to be followed, rule breakers can't complain that they face *natural* disadvantages. But since breaking the rules is also how history gets made, let's not *systematically* shut them out either.**

### A thousand *Yearling's Bobtail*s

So a rule breaker's biggest disadvantage is this: Because they aren't thrilled to put *any* time or energy into tools of empowerment, others treat them as lazy or inept. To counter this misreading, their only option is to pour *all* their time and energy into advancing the art form, with an ambitious demo that *couldn't* have been made for any less effort. Yet think of what this means:
