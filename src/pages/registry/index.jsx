...
Remember, the [indie gatekeepers](/indie#hustlers-lack-a-theory-of-future-minds), [poptimists](/indie#underdogs-are-supremacists-in-effect), and [tech platforms](/indie#fair-practices-follow-the-numbers) *want* to keep the artist's dilemma in place— each for their own reasons. If rock is to be saved, then, we need *others* to step up. Can one of these saviors be… you? Please contact any of our bands directly if you have an offer or opportunity for them to consider!
                `,
                (
