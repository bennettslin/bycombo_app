...
At BYCombo, we believe this "artist's dilemma" is the reason for the cultural stagnation of our times. To solve it, a generation of artists must now martyr themselves by doubling down to make art, for untold years of their lifetime, until business partners, discerning listeners, and future historians finally give them a chance. Here's how:

**Each BYCombo band promises *not* to hustle, but instead to earn your trust by sacrificing a serious chunk of lifetime— at least 25,000 hours, or twelve full-time years— on a demo that advances the art form.**

Remember, the [indie gatekeepers](/indie#hustlers-lack-a-theory-of-future-minds), [poptimists](/indie#underdogs-are-supremacists-in-effect), and [tech platforms](/indie#fair-practices-follow-the-numbers)— each for their own reasons— are *determined* to keep the artist's dilemma in place. If rock is to be saved, then, we need *others* to step up. Can one of these saviors be… you? Please contact any one of our bands directly if you have an offer or opportunity for them to consider!
                `,
                (
