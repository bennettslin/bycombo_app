...
${'  ' || `
// TODO: Mention instead tools meant to empower them.
`}
...
But remember, we require our bands *not* to care about self-empowerment— which means the indie gatekeepers will dismiss them as hobbyists! So if rock is to be saved, we need *others* to tell the world about them. Can one of these rock saviors… be you?
